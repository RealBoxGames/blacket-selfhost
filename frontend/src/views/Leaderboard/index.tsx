...
import { MiniNavbar, Modal } from "@components/index";
import { LittlePlacement } from "./components";
            ...
            <MiniNavbar items={[
                {
                    text: "Diamonds",
                    icon: "fas fa-gem",
                    active: sortBy === PlacementType.DIAMONDS,
                    onClick: () => setSortBy(PlacementType.DIAMONDS)
                },
                {
                    text: "Experience",
                    icon: "fas fa-star",
                    active: sortBy === PlacementType.EXPERIENCE,
                    onClick: () => setSortBy(PlacementType.EXPERIENCE)
                }
            ]} />
