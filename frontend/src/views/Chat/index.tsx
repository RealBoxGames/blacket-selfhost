                ...
                <ChatMessagesContainer aboveInput={replyingTo ? true : false}>
                    {memoizedMessages.map((message, index) => {
                        ...
                        return <ChatMessage
                            ...
                            message={message}
                            // newUser={
                            //     memoizedMessages[memoizedMessages.indexOf(message) + 1] && memoizedMessages[memoizedMessages.indexOf(message) + 1].authorId !== message.authorId ||
                            //     memoizedMessages.indexOf(message) === memoizedMessages.length - 1
                            // }
                            newUser={isNewUser}
                            ...
                            messageContextMenu={() => openContextMenu([
                                ...
                                { label: "Reply", icon: "fas fa-reply", onClick: () => {
                                    console.log("poop has been clicked");
